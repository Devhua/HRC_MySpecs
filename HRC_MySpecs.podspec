#
#  Be sure to run `pod spec lint HRC_MySpecs.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Devhua/HRC_MySpecs"
  ...
  s.source_files = "PodTestDemo/PodTestDemo/NetworkMonitor/*.{h,m}"
